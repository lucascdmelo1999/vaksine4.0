...
import com.example.demo.model.EmailMensagem;
...
public class EmailServicelmpl {
	...
	public void enviarConfirmacaoDeConta(Usuario usuario) throws MessagingException {
		...
		emailConfirmacao.setAssunto("Vaksine - confirmar conta!");
		emailConfirmacao.setMensagem(mensagem);
		emailConfirmacao.setNomeRemetente("Vaksine");
		emailConfirmacao.setEmailRemetente("Wesleycontato11@gmail.com");
